...
/** 
 * initialise the variable 'candy one' to the value of 43
 * increment the variable 'candy one' by 4
 * initialise the variable 'sugar two' by 27
 * increment the variable 'sugar two' by 9
 * initialise total to the average of candy one and sugar two.
 * console log the total and round the total to 1 decimal place.
 */
...
var sugarTwo = 27;
sugarTwo = 9; // 38
var total = (candyOne + sugarTwo)/2
console.log(total); //41.5


// Question 13 - write your own averaging question + answer
/** 
 * initialise the variable 'hat one' to the value of 32
 * increment the variable 'hat one' by 7
 * initialise the variable 'hoodie two' to the value of 12
 * decrement the variable 'hoodie two' by 4
 * initialise the variable 'shirt three' to the value of 18
 * increment the variable 'shirt three' by 5
 * initialise total to the average of hat one, hoodie two, and shirt three.
 * console log the total and round the total to 3 decimals place. Write a single line comment as to what will be displayed.
 */
...
var shirtThree = 18;
shirtThree += 5; // 23
var total = (hatOne + hoodieTwo + shirtThree)/3
console.log(total); //22.333


// Question 14 - write your own averaging question + answer
/** 
 * initialise the variable `apple one` to the value of 8
 * initialise the variable `apple two` to the value of 12
 * initialise the variable `apple three` to the value of 13
 * initialise the variable `apple four` to the value of 15
 * initialise total to the average of apple one, apple two, apple three, and apple four.
 * console log the total. Write a single line comment as to what will be displayed
 */
